...
class EntityManager {
    ...
    deleteWhere(entityClass, phRawDelete) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.localStore.deleteWhere(qEntity.__entityName__, phSqlDelete, this.localStore.activeChangeGroup);
        });
    }
    ...
    updateWhere(entityClass, phRawUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.localStore.updateWhere(qEntity.__entityName__, phSqlUpdate, this.localStore.activeChangeGroup);
        });
    }
