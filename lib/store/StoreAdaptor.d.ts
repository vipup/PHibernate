...
export interface IStoreAdaptor {
    ...
    delete<E>(entityName: string, entity: E, changeGroup: IChangeGroup): Promise<E>;
    ...
    save<E>(entityName: string, entity: E, changeGroup: IChangeGroup): Promise<E>;
    ...
    update<E>(entityName: string, entity: E, changeGroup: IChangeGroup): Promise<E>;
}
