...
import { Entity, EntityConfiguration, Id, ManyToOne, OneToMany, Repository, RepositoryConfiguration } from "./core/metadata/decorators";
...
export { CascadeType, Entity, EntityConfiguration, EntityField, EntityProxy, EntityProxyClass, FetchType, Id, ManyToOne, ManyToOneElements, OneToMany, OneToManyElements, IRepository, QRepository, QueryState, PH, PHChangeListConfig, PHEntityConfig, PHLocalStoreConfig, PHPersistenceConfig, ProxyGenerator, Repository, RepositoryConfiguration };
