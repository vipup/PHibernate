 ...
 */
import { Repository, RepositoryConfiguration } from "./core/metadata/decorators";
...
export { EntityField, EntityProxy, EntityProxyClass, IRepository, QRepository, QueryState, PH, PHChangeListConfig, PHEntityConfig, PHLocalStoreConfig, PHPersistenceConfig, ProxyGenerator, Repository, RepositoryConfiguration };
