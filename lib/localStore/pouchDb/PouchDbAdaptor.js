...
class PouchDbAdaptor {
    ...
    find(entityConstructor, phQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pouchDbQuery = new index_1.PouchDbQuery(phQuery.qEntity.__entityName__, phQuery.entitiesRelationPropertyMap, phQuery.entitiesPropertyTypeMap, jsonQuery);
