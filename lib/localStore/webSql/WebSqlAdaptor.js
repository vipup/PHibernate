...
class WebSqlAdaptor extends SqlAdaptor_1.SqlAdaptor {
    ...
    createNative(qEntity, columnNames, values, cascadeRecords) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (cascadeRecords.length) {
                ...
                for (let i = 0; i < cascadeRecords.length; i++) {
                    ...
                    yield this.create(cascadeRecord.entityName, cascadeRecord.manyEntity);
                }
                if (startTransaction) {
                    this.currentTransaction = null;
                }
    ...
    deleteNative(qEntity, entity, idValue, cascadeRecords, startNewTransaction = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (cascadeRecords.length) {
                ...
                for (let i = 0; i < cascadeRecords.length; i++) {
                    ...
                    yield this.delete(cascadeRecord.entityName, cascadeRecord.manyEntity, startTransaction);
                }
            }
            let tableName = PHMetadataUtils_1.PHMetadataUtils.getTableName(qEntity);
    ...
    updateNative(qEntity, columnNames, values, idProperty, idValue, cascadeRecords) {
        return __awaiter(this, void 0, void 0, function* () {
            let setFragments;
            let nativeValues = values.map((value) => this.convertValueIn(value));
                ...
                for (let i = 0; i < cascadeRecords.length; i++) {
                    ...
                    switch (cascadeRecord.cascadeType) {
                        case "create":
                            ...
                            break;
                        case "update":
                            yield this.update(cascadeRecord.entityName, cascadeRecord.manyEntity);
                            break;
                        case "remove":
