...
class QEntityChange extends deltarecord_1.QDeltaRecord {
    constructor(entityConstructor, entityName, alias) {
        ...
        // Relations
        this.booleanFieldChanges = new querydsl_typescript_1.QRelation(this, QEntityChange, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'BooleanFieldChange', 'booleanFieldChanges', booleanfieldchange_1.BooleanFieldChange, booleanfieldchange_2.QBooleanFieldChange);
        this.dateFieldChanges = new querydsl_typescript_1.QRelation(this, QEntityChange, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'DateFieldChange', 'dateFieldChanges', datefieldchange_1.DateFieldChange, datefieldchange_2.QDateFieldChange);
        this.numberFieldChanges = new querydsl_typescript_1.QRelation(this, QEntityChange, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'NumberFieldChange', 'numberFieldChanges', numberfieldchange_1.NumberFieldChange, numberfieldchange_2.QNumberFieldChange);
        this.stringFieldChanges = new querydsl_typescript_1.QRelation(this, QEntityChange, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'StringFieldChange', 'stringFieldChanges', stringfieldchange_1.StringFieldChange, stringfieldchange_2.QStringFieldChange);
        this.changeGroup = new querydsl_typescript_1.QRelation(this, QEntityChange, querydsl_typescript_1.RelationType.MANY_TO_ONE, querydsl_typescript_1.QStringField, 'ChangeGroup', 'changeGroup', changegroup_1.ChangeGroup, changegroup_2.QChangeGroup);
    }
    toJSON() {
