...
class QDateFieldChange extends abstractfieldchange_1.QAbstractFieldChange {
    ...
    static insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.insert(datefieldchange_1.DateFieldChange, entity);
        });
    }
    ...
    static updateWhere(phRawUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.updateWhere(datefieldchange_1.DateFieldChange, phRawUpdate);
        });
    }
    ...
    static deleteWhere(phRawDelete) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.deleteWhere(datefieldchange_1.DateFieldChange, phRawDelete);
        });
    }
    static save(entity) {
        return __awaiter(this, void 0, void 0, function* () {
