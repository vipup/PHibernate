...
class QChangeGroup extends deltarecord_1.QDeltaRecord {
    constructor(entityConstructor, entityName, alias) {
        ...
        // Relations
        this.entityChanges = new querydsl_typescript_1.QRelation(this, QChangeGroup, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'EntityChange', 'entityChanges', entitychange_1.EntityChange, entitychange_2.QEntityChange);
        this.entityWhereChanges = new querydsl_typescript_1.QRelation(this, QChangeGroup, querydsl_typescript_1.RelationType.ONE_TO_MANY, querydsl_typescript_1.QStringField, 'EntityWhereChange', 'entityWhereChanges', EntityWhereChange_1.EntityWhereChange, entitywherechange_1.QEntityWhereChange);
    }
    toJSON() {
