...
const entitywherechange_2 = require("./entitywherechange");
...
class QChangeGroup extends deltarecord_1.QDeltaRecord {
    constructor(entityConstructor, entityName, alias) {
        ...
        this.entityWhereChanges = new querydsl_typescript_1.QRelation(this, QChangeGroup, querydsl_typescript_1.RelationType.ONE_TO_MANY, 'EntityWhereChange', 'entityWhereChanges', entitywherechange_1.EntityWhereChange, entitywherechange_2.QEntityWhereChange);
    }
    toJSON() {
    ...
    static insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.insert(changegroup_1.ChangeGroup, entity);
        });
    }
    ...
    static updateWhere(phRawUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.updateWhere(changegroup_1.ChangeGroup, phRawUpdate);
        });
    }
    ...
    static deleteWhere(phRawDelete) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PH_1.PH.entityManager.deleteWhere(changegroup_1.ChangeGroup, phRawDelete);
        });
    }
    static save(entity) {
        return __awaiter(this, void 0, void 0, function* () {
