...
class QAbstractFieldChange extends deltarecord_1.QDeltaRecord {
    constructor(entityConstructor, entityName, alias) {
        ...
        // Fields
        this.entityRelationName = new querydsl_typescript_1.QStringField(this, QAbstractFieldChange, 'AbstractFieldChange', 'entityRelationName');
        this.propertyName = new querydsl_typescript_1.QStringField(this, QAbstractFieldChange, 'AbstractFieldChange', 'propertyName');
        // Relations
        this.entityChange = new querydsl_typescript_1.QRelation(this, QAbstractFieldChange, querydsl_typescript_1.RelationType.MANY_TO_ONE, querydsl_typescript_1.QStringField, 'EntityChange', 'entityChange', entitychange_1.EntityChange, entitychange_2.QEntityChange);
    }
    toJSON() {
