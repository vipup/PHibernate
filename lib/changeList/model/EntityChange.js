...
let EntityChange = class EntityChange extends AbstractEntityChange_1.AbstractEntityChange {
    ...
    addNewFieldChange(fieldName, entityRelationName, oldValue, newValue, field) {
    ...
    addNewBooleanFieldChange(fieldName, entityRelationName, oldValue, newValue) {
    ...
    addNewDateFieldChange(fieldName, entityRelationName, oldValue, newValue) {
    ...
    addNewNumberFieldChange(fieldName, entityRelationName, oldValue, newValue) {
    ...
    addNewStringFieldChange(fieldName, entityRelationName, oldValue, newValue) {
    ...
    addNewFieldChangeInternal(fieldName, entityRelationName, fieldChange) {
